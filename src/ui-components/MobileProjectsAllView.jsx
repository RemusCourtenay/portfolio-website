...
export default function MobileProjectsAllView(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "MobileProjectsAllView")}
      {...rest}
    >
      <Flex
        gap="0"
      ...
      >
        ...
        >
          <MobileProjectCircleView
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "MobileProjectCircleView3852054")}
          ></MobileProjectCircleView>
        </Flex>
        <Flex
          gap="0"
        ...
        >
          <MobileProjectCircleView
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "MobileProjectCircleView3852056")}
          ></MobileProjectCircleView>
        </Flex>
        <Flex
          gap="0"
        ...
        >
          <MobileProjectCircleView
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "MobileProjectCircleView3852058")}
          ></MobileProjectCircleView>
        </Flex>
      </Flex>
      <Flex

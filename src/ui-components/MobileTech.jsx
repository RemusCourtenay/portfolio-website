...
export default function MobileTech(props) {
  const { mobileTechSquaresGroup, overrides, ...rest } = props;
  return (
    <Flex
      gap="0"
      direction="column"
      ...
      {...getOverrideProps(overrides, "MobileTech")}
      {...rest}
    >
      <Flex
        gap="0"
      ...
      <Flex
        ...
        shrink="0"
        position="relative"
        children={mobileTechSquaresGroup}

...
export declare type WhatiofferOverridesProps = {
    "1"?: PrimitiveOverrideProps<ViewProps>;
    Whatioffer?: PrimitiveOverrideProps<ViewProps>;
...
export declare type WhatiofferProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: WhatiofferOverridesProps | undefined | null;
}>;
export default function Whatioffer(props: WhatiofferProps): React.ReactElement;
